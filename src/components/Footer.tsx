      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-8">
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-gray-500 tracking-wider uppercase flex items-center gap-3">
              <img src="/icons/hedgehog-svgrepo-com.svg" alt="" className="w-[50px] h-[50px]" />
              網站導航
            </h3>
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-gray-500 tracking-wider uppercase flex items-center gap-3">
              <img src="/icons/whale-svgrepo-com.svg" alt="" className="w-[50px] h-[50px]" />
              客戶服務
            </h3>
            <ul className="space-y-2">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-gray-500 tracking-wider uppercase flex items-center gap-3">
              <img src="/icons/polar-bear-svgrepo-com.svg" alt="" className="w-[50px] h-[50px]" />
              法律
            </h3>
            <ul className="space-y-2">
