          ...
          <div className="flex flex-col gap-6">
            ...
            <div>
              ...
              <div className="space-y-2">
                {product.desc_zh && (
                  <div>
                    <p className="text-gray-600 leading-relaxed">{product.desc_zh}</p>
                  </div>
                )}
                {product.desc_original && product.desc_original !== product.desc_zh && (
                  <div>
                    <p className="text-sm text-gray-500 leading-relaxed">原文描述：{product.desc_original}</p>
                  </div>
                )}
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className="flex-1 bg-primary text-white font-bold py-2 px-4 rounded-lg hover:bg-primary/90 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
