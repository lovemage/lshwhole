...
export default function LoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // 取得 access token，呼叫後端登入權限檢查 API
  ...
  return (
    <div className="relative flex min-h-screen w-full flex-col items-center justify-center p-4 group/design-root overflow-x-hidden" style={{ backgroundColor: '#f8f8f5' }}
    >
      {/* 背景圖覆蓋（若模板有） */}
      <div className="absolute inset-0 -z-10 bg-[url('/login_bg.jpg')] bg-cover bg-center opacity-10" aria-hidden />
        ...
        <div className="flex w-full flex-col rounded-xl border border-gray-200/80 bg-white/80 p-8 shadow-lg backdrop-blur-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <p className="text-center text-sm text-gray-600">
              還沒有帳號？
              <a href="/register" className="ml-1 font-semibold text-primary hover:underline">
                立即註冊
              </a>
            </p>
          </form>
